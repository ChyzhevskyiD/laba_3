...
namespace Lab_oop3_2
{
    ...
    class Student : User
    {
        ...
        public Student(int age, string name, int scholarship, int course) : base(age,
       name)
        {
    ...
    class Driver : Worker
    {
        ...
        public Driver(int age, string name, int salary, int DrivingExperience, string
       category) : base(age, name, salary)
        {
